...
from sdg_core_lib.dataset.processing.processors.pipeline_steps.TimeSeriesStepFactory import (
...
class TimeSeriesProcessor(Processor):
    ...
    pipeline configured with steps appropriate for time series features.
